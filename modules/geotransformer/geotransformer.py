...
from modules.transformer import SinusoidalPositionalEmbedding, RPEConditionalTransformer
...
class GeometricStructureEmbedding(nn.Module):
    ...
    def get_embedding_indices(self, points):
        ...
        #k = min(self.angle_k, dist_map.shape[-1]-1)
        k = self.angle_k
...
class GeometricTransformer(nn.Module):
    ...
    def forward(
        ...
        ref_feats, src_feats, attention = self.transformer(
            ref_feats,
            src_feats,
            ref_embeddings,
            src_embeddings,
        ...
        return ref_feats, src_feats, attention
