...
class LocalGlobalRegistration(nn.Module):
    ...
    def local_to_global_registration(self, ref_knn_points, src_knn_points, score_mat, corr_mat):
        ...
        for _ in range(self.num_refinement_steps - 1):
            ...
            estimated_transform = self.procrustes(src_corr_points, ref_corr_points, cur_corr_scores)
        three_indices = [batch_indices, ref_indices, src_indices]
        return global_ref_corr_points, global_src_corr_points, global_corr_scores, estimated_transform, three_indices
    ...
    def forward(
        ...
        #print("lgr:", self.use_dustbin, self.use_global_score)
        score_mat = score_mat * corr_mat.float()
        #print(score_mat.shape, corr_mat.shape)

        ref_corr_points, src_corr_points, corr_scores, estimated_transform, three_indices = self.local_to_global_registration(
        ...
        return ref_corr_points, src_corr_points, corr_scores, estimated_transform, three_indices
